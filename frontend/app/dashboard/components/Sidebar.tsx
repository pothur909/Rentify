...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-72 sticky top-20 left-0 h-[calc(100vh-7rem)] ml-6 my-6 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 shadow-xl rounded-2xl p-6 flex-col text-white">
      {/* Broker Info Card */}
      <div className="mb-6 pb-5 border-b border-white/20">
        <div className="w-16 h-16 bg-white/15 backdrop-blur-sm rounded-full mx-auto mb-3 flex items-center justify-center ring-2 ring-white/30">
          <User className="w-8 h-8 text-white" />
